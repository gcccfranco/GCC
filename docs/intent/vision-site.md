...
- Arbitrages restants de la relecture (`../feuille-de-route.md` § 7) : onglets
  de la barre du bas et navigation sans compte (lot 4). La cible « régie » de la
  chaîne (lot 7) est tranchée le 16/09/2026 : la régie du dimanche d'après le
  planning.
...
- **Tour 3 (pôles)** : tâches par pôle, module à part après les évènements ;
  ...
  attendant ; ~~QR code vers le calendrier fourni par l'app~~ (écarté le 18/09/2026 : Timothée crée son QR lui-même).
