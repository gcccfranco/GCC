...
(**encre, couleur du culte quand l'écran lui appartient** ; pas de mode louange
sur un chant seul, la planche l'avait inventé). Il veut mettre en ligne **tout
sauf le back-office** : liste tranchée et élargie le soir à **la grille du
planning (lecture comprise) et à toute la section Évènements**, interrupteur,
annonces retirées, 5C1 d'abord puis une seule mise en ligne
(`spec-mise-en-ligne.md`, **lot 18**, quatre questions ouvertes, attend le go).
`origin/main` a un commit de David en plus (22 liens YouTube) à fusionner.
