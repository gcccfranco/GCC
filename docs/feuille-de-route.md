...
| 4 | **Nouveau look** (chantier 5) | Direction visuelle à rechoisir (sobre, moins fade, moins « document ») ; **nom « GCC »**, menu par sections ; toutes les pages, mis en ligne d'un bloc ; pages d'administration au nouveau style sans réorganisation | tout le site ; `docs/audit-ui-apple-design.md` | L |
...
Toujours vrai : **capo conseillé en stand-by** ; **index A–Z balayable** (bug
voulu, à caser tôt) ; idée « modifié depuis ta dernière visite ».
